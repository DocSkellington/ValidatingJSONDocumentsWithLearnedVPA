 ...
 */
public class ROCAJSONEquivalenceOracle implements EquivalenceOracle.ROCAEquivalenceOracle<JSONSymbol> {
    ...
    public ROCAJSONEquivalenceOracle(int numberTests, int maxProperties, int maxItems, JSONSchema schema, Random random, boolean shuffleKeys) {
