...
import be.ac.umons.learningjson.oracles.exploration.ROCAJSONEquivalenceOracle;
...
public class ExplorationROCABenchmarks extends ROCABenchmarks {
    ...
    public ExplorationROCABenchmarks(final Path pathToCSVFile, final Duration timeout) throws IOException {
