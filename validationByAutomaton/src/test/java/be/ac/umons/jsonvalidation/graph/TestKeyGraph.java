...
public class TestKeyGraph {
    ...
    public void testStraightforwardAutomatonGraph() {
        ...
        WitnessRelation<Location> witnessRelation = WitnessRelation.computeWitnessRelation(automaton, reachabilityRelation);
        KeyGraph<Location> graph = new KeyGraph<>(automaton, reachabilityRelation, witnessRelation);
    ...
    public void testWitnessCycleInGraph() throws IOException {
        ...
        WitnessRelation<Location> witnessRelation = WitnessRelation.computeWitnessRelation(vpa, reachabilityRelation);
        KeyGraph<Location> graph = new KeyGraph<>(vpa, reachabilityRelation, witnessRelation);
        Assert.assertNotNull(graph.getWitnessCycle());
